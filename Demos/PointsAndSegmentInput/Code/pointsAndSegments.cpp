...
void zeEnd();
string outputListOfIntersectionPoints(const vector <shared_ptr<PointStruct> >& ptList,
									  const string& prefix);
...
const string rootFilePath = "../../../../DataFiles/savedScene";
...
void menuHandlerFunc(int value){
	switch (value){
		...
		case FIND_INTERSECTION_BRUTE:{
			...
			cout << outputListOfIntersectionPoints(intersectionPointList,
